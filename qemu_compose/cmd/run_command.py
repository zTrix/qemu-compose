...
def command_run(*, image_hint: str, name: Optional[str], publish: Optional[List[str]] = None) -> int:
    store = LocalStore()
    ...
    config = QemuConfig(name=name, image=resolved_id, ports=list(publish or []))
